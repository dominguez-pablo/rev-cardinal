  ...
  return (
    <footer className="site-footer">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li>
                <a href={homeHash('contacto')} className="footer-whatsapp">
      ...
      <div className="sticky-cta">
        ...
        <a href={homeHash('contacto')} className="sticky-cta-btn">
      ...
      <a aria-label="WhatsApp" className="whatsapp-float" href={homeHash('contacto')}>
